...
public class Config {
	...
	public static void preInit(FMLPreInitializationEvent event) {
		...
		seedWeight = config.getInt("seedWeight", Configuration.CATEGORY_GENERAL, 7, 1, 100, "Weight of Flax Seeds in the tall grass drop list (Wheat Seeds = 10, 0 to disable)");
